/* 
আরো কিছু ES6 এর জিনিস দেখবে আজকে (মডিউল ৩১)
...
আজকের মডিউলে মোট ৯টা ভিডিও। প্রথেমই আছে গতকাল যে কনসেপ্টগুলো শিখেছো সেগুলার রিভিশন। তারপর আসবে কয়েকটা ইন্টারমেডিয়েট লেভেলের কনসেপ্ট। যার প্রথমেই আছে object এর Destructuring নিয়ে কথা। এই জিনিসটার নাম কঠিন হলেও কাজ কিন্তু অনেক সোজা। কিছুই না।জাস্ট কোন একটা অবজেক্ট থেকে তার প্রপার্টি এর নাম নিয়ে ভেরিয়েবল ডিক্লেয়ার করবে। এই সিম্পল জিনিসটাই আমি ঘুরিয়ে পেঁচিয়ে বলতে বলতে পরের ভিডিওতে আরো সোজা করে বলেছি। জাস্ট ডানপাশে একটা অবজেক্টের মতো করে যে যে প্রপার্টি এর মান লাগবে সেই প্রপার্টি গুলার নাম লিখবে বামপাশে। আর ডানপাশে যে অবজেক্ট থেকে মানগুলো নিবে সেই অবজেক্ট লিখবে। বা সেই অবজেক্ট যে জায়গায় আছে সেটা লিখবে। আরো কিছু না।  সিমিলার সিস্টেমে আমরা Array থেকেও Destructuring নিয়ে আলোচনা করেছি। তারপরে আছে কখনো cannot find property of undefined টাইপের এরর পেয়ে গেলে কি করা লাগবে। 
.
...
৬. find এর filter এর মধ্যে ডিফারেন্স কি 
...
.
কন্সেপচুয়াল সেশন :
ES6 এর কোর জিনিসগুলা বুঝতে সমস্যা হবে অবশ্যই আগামীকাল কন্সেপচুয়াল সেশনে জয়েন করবে। কোন ভাবেই মিস দেয়া যাবে না। তাহলে রিভিশন ও হবে। প্রাকটিসও হবে। 
.
...
// fi you increae the array number it will still take equal perameter you have delceared 
console.log(p,q);

const [best, faltu] = ['Momotaz', 54]
console.log(best, faltu)

const {skay, money, color} = {skay:'blue', soil:"matti", color:'red', money:'500'}
...
console.log(compnay.web.employee);

// if you make mistake 
console.log(compnay?.back?.tridc)

// this qustion mark will work if you make mistake 
